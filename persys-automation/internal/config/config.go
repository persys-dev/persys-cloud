...
func Load() (*Config, error) {
	cfg := &Config{
		...
		PrometheusURL:   envOr("AUTOMATION_PROMETHEUS_URL", "http://prometheus:9090"),
		SchedulerAddr:   envOr("AUTOMATION_SCHEDULER_ADDR", "persys-scheduler:8085"),
		...
		ServerTLS:       envBoolOr("AUTOMATION_SERVER_TLS_ENABLED", true),
		...
		VaultManagerAddr: envOr("VAULT_MANAGER_ADDR","vault-manager:50069"),
		VaultEnabled:    envBoolOr("AUTOMATION_VAULT_ENABLED", true),
		VaultAddr:       envOr("AUTOMATION_VAULT_ADDR", "http://vault:8200"),
